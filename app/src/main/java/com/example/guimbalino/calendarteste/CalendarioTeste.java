...
/**
 * Created by guimbalino on 2/21/17.
 */

public class CalendarioTeste extends View {
    ...
    public CalendarioTeste(Context context) {
        this(context, null);
    }

    public CalendarioTeste(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CalendarioTeste(Context context, AttributeSet attrs, int defStyleAttr) {
