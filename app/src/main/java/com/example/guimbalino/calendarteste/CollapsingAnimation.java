...
class CollapsingAnimation extends Animation {
    ...
    private final CalendarioTeste view;
    private int targetGrowRadius;
    private final boolean down;
    private CompactCalendarController compactCalendarController;

    public CollapsingAnimation(CalendarioTeste view, CompactCalendarController compactCalendarController, int targetHeight, int targetGrowRadius, boolean down) {
        this.view = view;
