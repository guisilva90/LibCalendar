...
class AnimationHandler {
    ...
    private CalendarioTeste compactCalendarView;
    private CalendarioTeste.CompactCalendarAnimationListener compactCalendarAnimationListener;

    AnimationHandler(CompactCalendarController compactCalendarController, CalendarioTeste compactCalendarView) {
        this.compactCalendarController = compactCalendarController;
        this.compactCalendarView = compactCalendarView;
    }

    void setCompactCalendarAnimationListener(CalendarioTeste.CompactCalendarAnimationListener compactCalendarAnimationListener){
