package com.example.guimbalino.calendarteste;
...
import com.example.guimbalino.calendarteste.domain.Event;
...
import static com.example.guimbalino.calendarteste.CalendarioTeste.CompactCalendarViewListener;
import static com.example.guimbalino.calendarteste.CalendarioTeste.FILL_LARGE_INDICATOR;
import static com.example.guimbalino.calendarteste.CalendarioTeste.NO_FILL_LARGE_INDICATOR;
import static com.example.guimbalino.calendarteste.CalendarioTeste.SMALL_INDICATOR;
...
class CompactCalendarController {
    ...
    void onMeasure(int width, int height, int paddingRight, int paddingLeft) {
        ...
        bigCircleIndicatorRadius = shouldDrawIndicatorsBelowSelectedDays && eventIndicatorStyle == CalendarioTeste.SMALL_INDICATOR ? bigCircleIndicatorRadius * 0.85f : bigCircleIndicatorRadius;
    }
